...
def create_board(sudocooldata):
    """
    Creates a board object from the given SudoCool data
    """
    board_obj = SudocoolBoard.objects.create_sudocoolboard(sudocooldata)
    board = Board()
    board.populateByRow(board_obj.sudocoolData)
...
def solve_board(board):
    ...
    return solver.board.printByRow()
...
class BoardSolveTests(TestCase):
    ...
    def test_tough_board_one(self):
        """
        Check solution is correct
        """
        board = "3,,,,6,,,,,,,2,1,,,,,,,7,,,,9,3,,,,,1,,,,,3,2,,,6,,8,,4,,,2,5,,,,,9,,,,,8,5,,,,2,,,,,,,6,7,,,,,,,1,,,,5"
        solution = "3,8,5,7,6,4,2,1,9,9,6,2,1,3,8,5,7,4,1,7,4,2,5,9,3,6,8,8,4,1,9,7,5,6,3,2,7,9,6,3,8,2,4,5,1,2,5,3,6,4,1,9,8,7,4,3,8,5,9,7,1,2,6,5,1,9,8,2,6,7,4,3,6,2,7,4,1,3,8,9,5"
        b = create_board(board)
        bs = solve_board(b)

        self.assertEqual(bs, solution)

    def test_tough_board_two(self):
        """
        Check solution is correct
        """
        board = ",,9,3,,,,4,,,2,,6,,,,,8,3,,,,,,,,,,,,,,9,,8,5,,1,,,6,,,7,,4,5,,7,,,,,,,,,,,,,,2,1,,,,,5,,9,,,7,,,,4,5,,"
        solution = "6,8,9,3,5,7,2,4,1,7,2,5,6,4,1,9,3,8,3,4,1,9,2,8,7,5,6,2,3,7,4,1,9,6,8,5,9,1,8,5,6,2,3,7,4,4,5,6,7,8,3,1,2,9,5,9,3,8,7,6,4,1,2,1,6,4,2,3,5,8,9,7,8,7,2,1,9,4,5,6,3"
        b = create_board(board)
        bs = solve_board(b)
